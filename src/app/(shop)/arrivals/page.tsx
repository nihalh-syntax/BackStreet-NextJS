...
export const metadata: Metadata = {
  title: pageTitle("New Arrivals"),
  description: "Latest drops and seasonal pieces from BackStreet.",
}

export default async function NewArrivalsPage() {
  const products = await getProductsByCategory("newArrivals", 48)
    ...
    <div className="min-h-screen bg-background pb-16">
      <div className="mx-auto max-w-7xl px-4 py-6 md:px-6 md:py-10">
        ...
        <p className="mx-auto mt-3 max-w-2xl text-center text-sm text-muted-foreground md:text-base">
          Latest drops and seasonal pieces. Tap a product for details, sizes,
          and colors.
        </p>
